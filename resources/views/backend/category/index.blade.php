                    ...
                    <tbody>
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4 flex gap-4">
                                <a href="{{ route('category.edit', $category->id) }}" class="flex items-center text-green-600">
                                ...
                                <form action="{{ route('category.destroy', $category->id) }}" class="flex items-center text-red-600" method="post">
                                    @csrf
                                    @method('delete')
                                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
