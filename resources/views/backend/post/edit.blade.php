              ...
              <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="grid gap-6 mb-6 ">
                      ...
                      <div>
                          ...
                          <input type="text" id="meta_description" name="meta_description" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 p-4" value="{{ $post->meta_description }}" required />
                      </div>
                      <div>
                      ...
                      <div>
                          ...
                          @if($post->image) <!-- Assuming the image path is stored in the 'image' attribute of the Post model -->
                          <div class="mt-4">
                              <h6>Existing photo</h6>
                              <img src="{{ asset($post->image) }}" alt="" width="100" class="py-2">
                          </div>
                          @endif
                      </div>
                  ...
                  <div class="flex justify-center">
                      ...
                      <button class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Update News</button>
                  </div>
